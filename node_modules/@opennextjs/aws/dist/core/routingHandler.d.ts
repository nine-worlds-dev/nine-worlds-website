...
export declare const INTERNAL_HEADER_INITIAL_PATH = "x-opennext-initial-path";
export declare const INTERNAL_HEADER_RESOLVED_ROUTES = "x-opennext-resolved-routes";
export default function routingHandler(event: InternalEvent): Promise<InternalResult | RoutingResult>;
